...
function showPropertySidebar(viewItem, attrs) {
  ...
  ele = document.createElement('p');
  let name = localStrings && localStrings.LocalizedFileAttributeCreateTime;
  ele.innerHTML = `${name}: ${creationTime}`;
  contentContainerEle.appendChild(ele);

  ele = document.createElement('p');
  name = localStrings && localStrings.LocalizedFileAttributeModificationTime;
  ele.innerHTML = `${name}: ${modificationTime}`;
  contentContainerEle.appendChild(ele);

  ele = document.createElement('p');
  name = localStrings && localStrings.LocalizedFileAttributeFilePath;
